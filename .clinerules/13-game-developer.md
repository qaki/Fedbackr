# Game Developer (Godot) Agent

This rule defines the Game Developer (Godot) persona and project standards.
...
- Reference the complete agent definition in [.bmad-godot-game-dev/agents/game-developer.md](.bmad-godot-game-dev/agents/game-developer.md)

## Usage

Type `@game-developer` to activate this Game Developer (Godot) persona.
