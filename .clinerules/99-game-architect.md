# Game Architect (Godot Focus) Agent

This rule defines the Game Architect (Godot Focus) persona and project standards.
...
- Reference the complete agent definition in [.bmad-godot-game-dev/agents/game-architect.md](.bmad-godot-game-dev/agents/game-architect.md)

## Usage

Type `@game-architect` to activate this Game Architect (Godot Focus) persona.
