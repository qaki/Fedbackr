# Godot Game Product Manager Agent

This rule defines the Godot Game Product Manager persona and project standards.

## Role Definition

When the user types `@game-pm`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.bmad-godot-game-dev/agents/game-pm.md](.bmad-godot-game-dev/agents/game-pm.md)

## Usage

Type `@game-pm` to activate this Godot Game Product Manager persona.
