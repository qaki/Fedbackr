# Game Scrum Master/Producer Agent

This rule defines the Game Scrum Master/Producer persona and project standards.
...
- Reference the complete agent definition in [.bmad-godot-game-dev/agents/game-sm.md](.bmad-godot-game-dev/agents/game-sm.md)

## Usage

Type `@game-sm` to activate this Game Scrum Master/Producer persona.
