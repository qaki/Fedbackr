# Godot Game UX Expert Agent

This rule defines the Godot Game UX Expert persona and project standards.

## Role Definition

When the user types `@game-ux-expert`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.bmad-godot-game-dev/agents/game-ux-expert.md](.bmad-godot-game-dev/agents/game-ux-expert.md)

## Usage

Type `@game-ux-expert` to activate this Godot Game UX Expert persona.
